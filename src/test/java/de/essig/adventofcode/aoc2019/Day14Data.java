...
public class Day14Data {
    ...
    public final static String SAMPLE_ONE = "10 ORE => 10 A\n" +
            "1 ORE => 1 B\n" +
            "7 A, 1 B => 1 C\n" +
            "7 A, 1 C => 1 D\n" +
            "7 A, 1 D => 1 E\n" +
    ...
    public final static String SAMPLE_TWO = "9 ORE => 2 A\n" +
            "8 ORE => 3 B\n" +
            "7 ORE => 5 C\n" +
            "3 A, 4 B => 1 AB\n" +
            "5 B, 7 C => 1 BC\n" +
    ...
    public final static String SAMPLE_THREE = "157 ORE => 5 NZVS\n" +
            "165 ORE => 6 DCFZ\n" +
    ...
    public final static String SAMPLE_FOUR = "2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG\n" +
            ...
            "176 ORE => 6 VJHF";
    public final static String SAMPLE_FIVE = "171 ORE => 8 CNZTR\n" +
    ...
    public final static String PROGRAM = "9 RJLWC, 9 RJCH => 9 QWFH\n" +
