        ...
        for(int y = 0; y <= yMax; y++) {
            for (int x = 0; x <= xMax; x++) {
                if(isIntersection(x,y)){
                    System.out.println("Intearsection " + x + "/" + y);
